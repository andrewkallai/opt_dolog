...
#source $PREFIX/opt_dolog/tensorflow_updated/bin/activate
...
export OUTPUT_DIR=$PREFIX/model11
...
# export OUTPUT_PERFORMANCE_PATH=$PREFIX/opt_dolog/performance_report/rl_fast_report.txt && \
# PYTHONPATH=$PYTHONPATH:. python3 \
# compiler_opt/tools/generate_default_trace.py \
#   --data_path=$CORPUS \
...
#  --policy_path=$PREFIX/model/policy/94800/saved_policy \
